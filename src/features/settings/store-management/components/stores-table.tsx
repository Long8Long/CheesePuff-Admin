...
const route = getRouteApi('/_authenticated/settings/store-management')
...
export function StoresTable() {
  ...
  const {
    ...
    queryKey: ['stores', pagination.pageIndex + 1, pagination.pageSize, columnFilters, globalFilter],
    queryFn: () =>
      storesService.getList({
